...
export default function JoinGroupPage() {
  ...
  return <main className="join-page min-h-screen bg-[#070707]"><PublicHeader />
    <section className="join-hero"><div className="join-hero-grid" aria-hidden="true" /><div className="relative z-10 mx-auto grid max-w-6xl gap-10 px-4 py-16 lg:grid-cols-[1fr_.72fr] lg:items-end lg:py-24"><div><p className="join-label"><Sparkles className="h-4 w-4" /> Membership application</p><h1 className="join-title mt-5">Earn your place.<br /><span>Join the crew.</span></h1><p className="mt-6 max-w-xl text-base leading-8 text-[#aa978c]">Rebels on Roads is built on discipline, trust and shared responsibility. Tell us who you are, what you ride and why the road matters to you.</p></div><div className="join-hero-promise"><ShieldCheck /><div><strong>Verified membership</strong><span>Every rider is reviewed by the command center before joining.</span></div></div></div></section>
